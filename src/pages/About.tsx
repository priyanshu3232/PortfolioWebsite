          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                At CreativeGrowth, we believe every business deserves to reach its full potential. Our mission is to democratize access to world-class digital marketing strategies that were once only available to enterprise-level companies.
              </p>
