          ...
          <div className="relative">
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8">
              ...
              <div className="grid grid-cols-2 gap-8 items-center justify-items-center">
                ...
                {/* Shopify */}
                <div className="flex items-center justify-center p-4 bg-custom-beige rounded-xl hover:bg-stone-100 transition-colors duration-300 w-full h-20 col-span-2">
